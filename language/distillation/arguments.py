...
def parse_args():
    ...
    parser.add_argument(
        "--student_bert_config", required=True, type=str, help="location of config.json"
    )
    parser.add_argument(
        "--teacher_bert_config", required=True, type=str, help="location of config.json"
    )
    ...
    parser.add_argument(
        "--student_load_pretrain_model",
        default="",
        type=str,
        help="location of model's checkpoin",
    )
    parser.add_argument(
        "--teacher_load_pretrain_model",
        default="",
        type=str,
        help="location of model's checkpoin",
    )
    ...
    parser.add_argument(
        "--student_mlm_model_type",
        default="bert",
        type=str,
        help="model type, bert or deberta",
    )
    parser.add_argument(
        "--teacher_mlm_model_type",
        default="bert",
        type=str,
        help="model type, bert or deberta",
    )
